...
def index (): 
    ...
    post_urls = ['pages/landing.html', 'posts/origin-story_snipped.html', 'posts/intern-problems_snipped.html', 'posts/desconstructing-sanfranciscos-class-war_snipped.html', 'pages/about.html']
